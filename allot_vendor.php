...
<!-- ================== popup for the venor alltment================================================================================ -->
      ...
      <div class="modal fade" id='forwardvendor' style="text-align:center;opacity:1;display:none;    margin-top: 53px;
    width: 60%;
...
VENDOR ALLOTMENT 
  ...
  <table class="table" style='font-size: 11px;'>
    ...
    <tbody>
      ...
      ?>">
        <td><?php echo $r+1;?></td>
        <td><?php echo '( '.$arr2[$r]['vendor'].' )';?></td>
                <td><?php echo $arr2[$r]['service'];?></td>
