...
$cmd="insert into transaction(sl,trans_id,customer,email,phonenumber,pickupaddress,pickuptime,pickupdate,brand,model,devicetype,problem,bookingdate) values 
('','$trans_id','$name2','$email2','$phone2','$pickupaddress','$freetime','$freedate','$brandname','$modelname','$devicetype','$problemid','$bookingdate')";
...
<center>
			...
			<li style='display:inline-block'>
				...
				<a href="javascript:void(0)" id='mobiletab' onclick="get_problem_dropdown('mobile_tab_problems');clear_other_tabs();get_back_change(this);document.getElementById('devicetype').value='mobile'"  class="top_tab_buttons"  
			...
			<a href="javascript:void(0)" onclick="get_problem_dropdown('mobile_tab_problems');clear_other_tabs();get_back_change(this);document.getElementById('devicetype').value='tablet'" id='tabtab'  class="top_tab_buttons"  
					...
					>LAPTOP </a></li>
						...
						<li style='display:inline-block'>
							...
							<a href="javascript:void(0)" id='pctab' onclick="get_problem_dropdown('laptop_problems');clear_other_tabs();get_back_change(this);document.getElementById('devicetype').value='desktop'" class="top_tab_buttons"  
...
<select id="mobile_tab_problems" onchange="document.getElementById('problemid').value=this.value;" style='    max-width: 200px;
    height: 31px;
    font-size: 12px;
...
<select id="laptop_problems" onchange="document.getElementById('problemid').value=this.value;" style='    max-width: 200px;
...
<select id="pc_problems" onchange="document.getElementById('problemid').value=this.value;" style='    max-width: 200px;
    height: 31px;
...
<center>
<span style='font-size:12px;color:red'>Please enter the password alloted to you.<br>

After successfull booking SMS Acknowledgement will be sent at this phone number.
 <strong id='phonesentotp'></strong><br></span>


						<input type="password" id='userotp' class='text_fld1' placeholder='4-Digit OTP' name="phone2" name="phone2" ><br>		
...
// AJAX Code To Submit Form.
var dataString ='problemid='+problemid+'&brandname='+brandname+'&modelname='+model+'&pickupaddress='+pickupaddress+'&freedate='+freedate+'&freetime='+freetime+'&name2='+name2+'&email2='+email2+'&phone2='+phone2+'&devicetype='+devicetype+'&submit_transaction='+1;
