...
include('gatracking/analyticstracking.php');
...
$msgcustomer="Your service ticket has been raised with SRN- ".$trans_id." .";
						...
						if(isset($_POST['sendotp']))
{
	...
	$msgborn="User your online verfication code is ".$otpcode." .Please enter and verify your order.";
		sendmessage($msgborn,$phone);
                        ...
                        $msgborn="Greetings! from Instarepair . You will be soon be contacted by our executive.";
...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="ss.png" />
...
.banner {
  background-size: 676px;
            background-position: 404px 406px;
...
<!-- the hiddenb text -->
		...
		<div class="banner-info" style='display:non5e'>
				...
				<h3 style='color:black;text-transform:capitalize;font-weight:bold:font-family: helvetica;'>Quickest way to repair your gadget 
<br>
...
<div class='container' id='insta_servicestab'>
							...
							<div class='col-md-3'>
                            <form action="calculate-mobile-computers-repair-costing">
    <input type="submit" value="REPAIR PRICE"  class="button" style="margin-bottom:-4vw">
</form>

                            <!-- <button type="button"  onclick="calculate-mobile-computers-repair-costing"   class="button" >REPAIR PRICE</button> -->
             <!-- <input type="submit" class='a_button' id="a_button_repairprice style="margin-left:26%" value="REPAIR PRICE"> -->
    ...
    onmouseout="change_button_font_color_mouseout('a_button_repairprice')" >
				<a href="calculate-mobile-computers-repair-costing" class'a_button=' id"a_but=ton_repairprice">
		REPAIR PRICE
							...
							<div class='col-md-3'>
                            <button type="button"  onclick="#" data-toggle="modal"  class="button"  data-target="#bookrepair">BOOK REPAIR</button>
...
<a href="#"  data-toggle="modal" id='a_button_repair'  class='a_button' data-target="#bookrepair" >
		BOOK REPAIR
							...
							<div class='col-md-3'>
                        <button type="button"  onclick="#" data-toggle="modal"  class="button"  data-target="#requestacallback">REQUEST A CALLBACK</button>
    ...
    onmouseout="change_button_font_color_mouseout('a_button_callback')" >
		...
		REQUEST A CALLBACK
					...
					<div class='col-md-3'>
                     <form action="sell-your-mobile-laptop-gadgets-at-the-best-prices">
    <input type="submit" value="SELL USED GADGET"  class="button">
</form>
...
<a href="#"  data-toggle="modal" id='a_button_repair' data-target="#bookrepair" >
					<div class='col-md-3 col-sm-12 col-xs-6'>
	<div id='yellow_tab_outline'>
			<span >
...
<a href="#" id='a_button_repair'  data-toggle="modal" data-target="#bookrepair" >

							<div class='col-md-3 col-sm-12 col-xs-6'>
	<div id='yellow_tab_outline'>
			<span >
<img src="img/smartwatch.png" class='device_pic' style='  '>
			</span>
...
<!-- data-align="left" -->
<!-- data-overlay="true" -->
<script data-align="right" data-overlay="false" id="keyreply-script" src="//keyreply.com/chat/widget.js" data-color="#F4B912 " data-apps="JTdCJTIydHdpdHRlciUyMjolMjJAaW5zdGFfcmVwYWlyJTIyLCUyMndoYXRzYXBwJTIyOiUyMjcyOTAwMjkxNzUlMjIsJTIycGhvbmUlMjI6JTIyODElMjAwMCUyMDc1JTIwNzUlMjA3NSUyMiwlMjJmYWNlYm9vayUyMjolMjJpbnN0YXJlcGFpci5pbiUyMiwlMjJlbWFpbCUyMjolMjJtYWlsQGluc3RhcmVwYWlyLmluJTIyJTdE"></script>
