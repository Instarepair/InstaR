...
<a href="tel:00-00-000-000"  data-rel="external" style="" class='phone_number_hidden' >
...
<div class='container' id='insta_servicestab'>
    ...
    onmouseout="change_button_font_color_mouseout('a_button_repairprice')" >
				<a href="repair-pricing.php" class='a_button' id="a_button_repairprice">
		REPAIR PRICE
...
<a href="#"  data-toggle="modal" id='a_button_repair'  class='a_button' data-target="#bookrepair" >
    ...
    onmouseout="change_button_font_color_mouseout('a_button_sellused')" >
					<a href="buybackuser.php" class='a_button' id='a_button_sellused'>
		SELL USED GADGET
...
<img src='img/Warranty.png' class='why_insta_pics'>
