        ...
        if(isset($_POST['submittransactiondata'])){
             ...
             $freedate=$_POST['freedate'];
                   $problem=$_POST['problem'];
                    $remark=$_POST['remark'];
$cmd="update transaction set remark='$remark',customer='$name',problem='$problem',email='$email',pickupaddress='$address',devicetype='$devicetype',model='$model',brand='$brand',phonenumber='$contact',pickuptime='$freetime',pickupdate='$freedate' where trans_id='$trans_id'";
...
EDIT TRANSACTION ID: <?php echo $trans_id; ?>
  ...
  <table class="table" style='font-size: 11px;'>
    <thead>
     ...
     <!-- <tr><td> REMARKS :</td><td><input type="text" name="remark" value="<?php echo $arr1[0]['remark'];?>"></td></tr> -->

     <tr><td> REMARKS :</td><td><textarea rows="5" cols="50" name="remark"><?php echo $arr1[0]['remark'];?></textarea></td></tr>
