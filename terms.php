...
Please read the following terms and conditions of use carefully before using this website http://www.instarepair.in/
This website (hereafter this “Website”) is made available by Instarepair Solutions Private Limited, a company incorporated in India under Companies Act, 2013. This Website is offered to you (hereafter the “User”), conditioned on your acceptance of these Terms and Conditions of Use. The Terms and Conditions of Use will be deemed to constitute a legally binding contract between the User and Instarepair. If you do not accept these Terms and Conditions of Use, please exit this Website.

You should read the terms and conditions carefully as they contain: 
Important information and instructions such as how long it lasts, fees for early termination, our rights to change its conditions, limitations of liability, privacy, and settlement of disputes by arbitration instead of in court. If you accept this agreement, it will apply to all your service plans from us, including all your existing plans. Your acceptance of these terms & conditions will be implied by the use of the instarepair.in service.
...
FAIR USAGE POLICY; SUSPENSION OR TERMINATION OF SUBSCRIPTION:</strong><br>
...
Liability disclaimer</strong><br>
...
User is solely responsible for his/her use of this Website including content, material and information posted, published, submitted or otherwise disseminated by User through this Website. User will use this Website legally and only for the purposes that it is intended to be used for.
...
Pricing</strong><br>
All Price quotations are subject to the terms and conditions stated herein as well as any additional terms and conditions that may appear on the face of the accepted quotation. All published prices are subject to change without any prior notice. The company shall entertain no refund claims due to any subsequent price drop on account of any offer, promotion and promos or otherwise. 
