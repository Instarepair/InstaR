...
$linkcreated="www.instarepair.in/team";

$redirectlink='allot_delivery.php?orderid='.$orderid;
if($bill==''){
?>
<center>


  <span style="color:red"> No billing has been done for this order Id. Please enter the bill amount for dispatchment.</span>
<form action='#' method='post' >
...
<input type="text" name='trackid' style='display:none' value="<?php echo $orderid; ?>">
        ...
        value="<?php echo $customerarr[0]['customer']?>" name='customername'>
         ...
         value="<?php echo $linkcreated;?>" name='link'> <br>
                 ...
                 <input type='text' class='text_fld1' style='display:none'  placeholder='' 
         value="<?php echo $redirectlink;?>" name='redirectlink'> <br>
...
<?php }else
{ ?>
                    <a href="javascript:void(0)" onclick="create_link_for_deliveryid()">
                     click here to assign delivery person </a>  
  <?php 
