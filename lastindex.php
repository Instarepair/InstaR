...
<div class="banner" style="    background: url('images/insta-homepage.png');
    background-size: 100%;">
	<div class="header">	
			<div class="logo">
			   <h1><a href="index.html"><i><img src="images/cell.png" alt=" " /></i>InstaRepair</a></h1>
			</div>
			<div class="top-nav">
				<span class="menu"><img src="images/menu.png" alt=" " /></span>
				<ul class="nav1">
					<li><a href="#" data-toggle="modal" data-target="#myModal">Request a callback</a></li>
					<li><a href="#" data-toggle="modal" data-target="#myModal2">Track Order</a></li>
					<li><a href="#" data-toggle="modal" data-target="#myModal1">How we work</a></li>
	...
	<div class="container">
		<div class="banner-info">
			<h3>Smart Repair For Smart People

				<span style='color:orange'>#GoInstaRepair</span>
</h3>
		</div>
		<div class="buttons">
			<ul>
				<li ><a class="hvr-shutter-in-vertical" href="#" data-toggle="modal" data-target="#myModal">Mobile</a></li>
				<li><a class="hvr-shutter-in-vertical" href="#" data-toggle="modal" data-target="#myModal1">Tablets</a></li>
								...
								<div class="login">
									...
									<div class="login-right">
										<form action="#" method='post'>
											...
											<input type="text"name="username"  value="Enter your mobile number or Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter your mobile number or Email';}" required="">	
											...
											<input type="submit" name="submitlogin" value="SIGNIN" >
										</form>
									</div>
									<div class="clearfix"></div>								
								</div>
								...
								<div class="login">
									...
									<div class="login-right">
										<form action="#" method="post" >
											...
											<input type="text"  name="name1" value="Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}" required="">
											<input type="text"  name="email1" value="Mobile number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Mobile number';}" required="">
												<input type="password" name="password1"  value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">	
											<input type="password" name="password2"  value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">	
											
											<input type="submit" name='submitregister' value="CREATE ACCOUNT" >
										</form>
									</div>
									<div class="clearfix"></div>								
								</div>
